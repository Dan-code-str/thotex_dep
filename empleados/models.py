...
class Empleado(models.Model):
    ...
    (22, 'Citibank'),
    (23, 'Coopcentral'),
    (24, 'Cooperativa confiar'),
    (25, 'Cooperativa cootramed'),
    (26, 'Cooperativa cotrafa'),
    (27, 'Cooperativa de ahorro y crédito nacional'),
    (28, 'Cooperativa financiera de antioquia'),
    (29, 'Cooperativa utrahuilca'),
    (30, 'Cooprofesores'),
    (31, 'Davivienda'),
    (32, 'Daviplata'),
    (33, 'Mibanco'),
    ...
    Emp_fechaingreso = models.DateField(verbose_name="fecha de ingreso")
    Emp_fechaFinContrato = models.DateField(verbose_name="fecha fin de contrato")
    Emp_banco = models.IntegerField(max_length = 60, choices=bancos, verbose_name='Banco')
